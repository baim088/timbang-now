...
public class AuthViewModel extends ViewModel {
    ...
    public void register(String email, String password, String nama, String alamat, String telepon, int usia, String jenisKelamin) {
        authRepo.register(email, password, nama, alamat, telepon, usia, jenisKelamin, new AuthRepository.AuthCallback() {
            @Override
            public void onSuccess(String message) {
