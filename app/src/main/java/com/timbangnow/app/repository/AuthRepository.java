...
public class AuthRepository {
    ...
    public void register(String email, String password, String nama, String alamat, String telepon, int usia, String jenisKelamin, AuthCallback cb) {
        auth.createUserWithEmailAndPassword(email, password)
                .addOnSuccessListener(authResult -> {
                    ...
                    if (firebaseUser != null) {
                        ...
                        User newUser = new User(uid, nama, alamat, telepon, usia, jenisKelamin, 0.0, email, System.currentTimeMillis(), "user");
